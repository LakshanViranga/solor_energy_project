...
$max_power = mysqli_query($konek, 'SELECT  MAX(power) FROM ( SELECT * FROM curve ORDER BY id DESC LIMIT 3) Var1 ORDER BY ID ASC') ;
...
if (mysqli_num_rows($temp) > 0) {
  $row1 = mysqli_fetch_all($temp);
  $temperature =  $row1[0][0];
}
